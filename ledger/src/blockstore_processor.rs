...
pub mod tests {
    ...
    fn test_check_accounts_data_block_size() {
        ...
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config((1_000_000 + NUM_ACCOUNTS + 1) * LAMPORTS_PER_NZT);
    ...
    fn test_check_accounts_data_total_size() {
        ...
        const ACCOUNT_BALANCE: u64 = 70 * LAMPORTS_PER_NZT; // rent exempt amount for a 10MB account is a little less than 70 SOL
