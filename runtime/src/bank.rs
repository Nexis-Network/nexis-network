...
impl Bank {
    ...
    pub fn new_with_paths(
        genesis_config: &GenesisConfig,
        // TODO(nexis): Remove option, currently need for Bank::new/default, that is used for tests
        ...
        let evm_state = if let Some((evm_state_path, evm_genesis_path)) = evm_paths {
            ...
            //TODO(nexis): Rename default to test
    ...
    pub fn evm_burn_fee_activated(&self) -> bool {
        self.feature_set
            .is_active(&feature_set::nexis::burn_fee::id())
    }
    ...
    fn check_message_for_nonce(&self, message: &SanitizedMessage) -> Option<TransactionAccount> {
            ...
            .is_active(&feature_set::nonce_must_be_authorized::ID)
        {
            ...
            .feature_set
            .is_active(&feature_set::nexis::disable_durable_nonce::id())
        {
            return None;
        }
    ...
    fn execute_loaded_transaction(
            ...
            if let Some(state) = &evm_patch {
                let evm_executor = evm_state::Executor::with_config(
                    ...
                    evm_state::executor::FeatureSet::new(
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::nexis::unsigned_tx_fix::id()),
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::nexis::clear_logs_on_error::id()),
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::nexis::accept_zero_gas_price_with_native_fee::id()),
                    ),
                );
                Some(evm_executor)
            } else {
        ...
        //TODO(nexis): Move evm_state apply to update executors
        let evm_new_error_handling = self
            .feature_set
            .is_active(&solana_sdk::feature_set::nexis::evm_new_error_handling::id());
        if let Some(evm_executor) = evm_executor {
                ...
                && evm_new_error_handling
            {
                let clear_logs = self
                    .feature_set
                    .is_active(&solana_sdk::feature_set::nexis::clear_logs_on_native_error::id());
                evm_patch
                    .as_mut()
    ...
    fn fix_spv_proofs_evm(&self) -> bool {
        self.feature_set
            .is_active(&feature_set::nexis::hardfork_pack::id())
    }
    ...
    fn apply_feature_activations(
        ...
        if !debug_do_not_add_builtins {
            ...
            self.reconfigure_token2_native_mint(
                new_feature_activations.contains(&feature_set::nexis::hardfork_pack::id()),
            );
        }
    ...
    fn reconfigure_token2_native_mint(&mut self, reconfigure_token2_native_mint_nexis: bool) {
        ...
        let reconfigure_token2_native_mint =
            reconfigure_token2_native_mint_old || reconfigure_token2_native_mint_nexis;
...
pub(crate) mod tests {
    ...
    fn test_interleaving_locks_evm_tx() {
        ...
        bank.activate_feature(&feature_set::nexis::evm_instruction_borsh_serialization::id());
    ...
    fn test_evm_second_tx_with_same_nonce() {
        ...
        bank.activate_feature(&feature_set::nexis::native_swap_in_evm_history::id());
        bank.activate_feature(&feature_set::nexis::evm_new_error_handling::id());
        bank.activate_feature(&feature_set::nexis::evm_instruction_borsh_serialization::id());
        let recent_hash = genesis_config.hash();
    ...
    fn test_evm_revert_tx() {
        ...
        let state_swapper = evm_state
            .get_account_state(*solana_evm_loader_program::precompiles::ETH_TO_NZT_ADDR)
            .unwrap_or_default();
    ...
    fn test_bank_hash_internal_state_verify_transfer_evm() {
        ...
        bank0.activate_feature(&feature_set::nexis::evm_instruction_borsh_serialization::id());
    ...
    fn test_accounts_data_size_and_resize_transactions() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = genesis_utils::create_genesis_config(100 * LAMPORTS_PER_NZT);
        let mut bank = Bank::new_for_tests(&genesis_config);
        let mock_program_id = Pubkey::new_unique();
        bank.add_builtin(
            "mock_realloc_program",
        ...
        bank.store_account(
            &funding_keypair.pubkey(),
            &AccountSharedData::new(10 * LAMPORTS_PER_NZT, 0, &mock_program_id),
        );
        ...
        // Test case: Grow account
        {
            ...
            let account_balance = LAMPORTS_PER_NZT;
