...
mod tests {
    ...
    // DEFINE_SNAPSHOT_VERSION_PARAMETERIZED_TEST_FUNCTIONS!(V1_4_0, Spark, V1_4_0_Spark);
    ...
    DEFINE_SNAPSHOT_VERSION_PARAMETERIZED_TEST_FUNCTIONS!(V1_5_0, Spark, V1_5_0_Spark);
