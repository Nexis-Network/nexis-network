    ...
    let matches = App::new(crate_name!()).about(crate_description!())
        ...
        .arg(
            Arg::with_name("evm_state_rpc_port")
                ...
                .validator(nexis_validator::port_validator)
        ...
        .arg(
            Arg::with_name("dynamic_port_range")
                ...
                .validator(nexis_validator::port_range_validator)
...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    let account_indexes: HashSet<AccountIndex> = matches
        ...
        .map(|value| match value {
            ...
            "nexis-accounts-storages" => AccountIndex::NexisAccountStorage,
            "nexis-accounts-owners" => AccountIndex::NexisAccountOwner,
            "nexis-accounts-operationals" => AccountIndex::NexisAccountOperational,
            "nexis-relying-party-owners" => AccountIndex::NexisRelyingOwner,
